    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="<?php echo e(route('userportal')); ?>" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-warning"><i class="fa fa-user-edit me-2"></i><?php echo e(config('app.name')); ?></h3>
                </a>
                <div class="navbar-nav w-100">
                    <a href="<?php echo e(route('userportal')); ?>"
                        class="nav-item nav-link <?php echo e(Helper::activeLink(['userportal'])); ?>"><i
                            class="fa fa-home me-2"></i>Accueil</a>
                    <a href="<?php echo e(route('galerie')); ?>"
                        class="nav-item nav-link <?php echo e(Helper::activeLink(['galerie', 'addimage', 'editimage'])); ?>">
                        <i class="fa fa-th me-2"></i>Galerie</a>
                    <a href="<?php echo e(route('categories')); ?>"
                        class="nav-item nav-link <?php echo e(Helper::activeLink(['categories', 'addcatgorie', 'editcatgorie'])); ?>"><i
                            class="far fa-file-alt me-2"></i>Categorie Plat</a>
                    <a href="<?php echo e(route('carte')); ?>"
                        class="nav-item nav-link <?php echo e(Helper::activeLink(['carte', 'addplat', 'editplat'])); ?>"><i
                            class="fa fa-table me-2"></i>Publier la carte</a>
                    <a href="<?php echo e(route('menus')); ?>"
                        class="nav-item nav-link <?php echo e(Helper::activeLink(['menus', 'addmenu', 'editmenu'])); ?>"><i
                            class="fa fa-utensils me-2"></i>Menu</a>
                    <a href="<?php echo e(route('formules')); ?>"
                        class="nav-item nav-link <?php echo e(Helper::activeLink(['formules', 'addformule', 'editformule'])); ?>"><i
                            class="fa fa-keyboard me-2"></i>Formules</a>
                    <a href="<?php echo e(route('jours')); ?>" class="nav-item nav-link <?php echo e(Helper::activeLink(['jours', 'addjour', 'editjour'])); ?>"><i class="fa fa-check me-2"></i>Jours</a>
                    <a href="<?php echo e(route('horaires')); ?>" class="nav-item nav-link <?php echo e(Helper::activeLink(['horaires', 'addhoraire', 'edithoraire'])); ?>"><i class="fa fa-clock me-2"></i>Horaires</a>
                    <a href="<?php echo e(route('convives')); ?>" class="nav-item nav-link <?php echo e(Helper::activeLink(['convives', 'setconvivesseuil', 'editconvivesseuil'])); ?>"><i class="fa fa-users me-2"></i>Convives</a>
                    <a href="<?php echo e(route('reservations')); ?>" class="nav-item nav-link <?php echo e(Helper::activeLink(['reservations', 'voirereservation'])); ?>"><i class="fa fa-list me-2"></i>Réservations</a>
                    <a href="<?php echo e(route('utilisateurs')); ?>" class="nav-item nav-link <?php echo e(Helper::activeLink(['utilisateurs', 'addutilisateur', 'editutilisateur'])); ?>"><i class="fa fa-users me-2"></i>Utilisateurs</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
...
<?php /**PATH C:\AppsWeb\QuaiAntique\resources\views/account/main.blade.php ENDPATH**/ ?>