                            ...
                            <div class="control-group mb-3">
                                ...
                                <div class="input-group">
                                    <select class="custom-select form-control" name="allergies[]" multiple>
                                        <option selected value="">----Allergique au----</option>
                                        <?php
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\AppsWeb\QuaiAntique\resources\views/reserver.blade.php ENDPATH**/ ?>