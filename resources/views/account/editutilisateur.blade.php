            ...
            <div class="bg-secondary rounded h-100 p-4 col-8">
                <form method="POST">
                    ...
                    <div class="form-floating  mb-3">
                            <input type="text" class="form-control" name="name" placeholder="Pseudo" required="required" value="{{$user->name}}">
                    ...
                    <select class="form-select" name="type" aria-label="Floating label select example" required>
                        <option @if ($user->type == "client") selected @endif value="client">Client</option>
